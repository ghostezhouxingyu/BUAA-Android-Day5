...
public class Solution2C1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRv.setAdapter(new Adapter() {
            ...
            public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
                ...
                // TO.DO-C1 (4) Uncomment these 2 lines, assign image url of Cat to this url variable
    ...
    public void requestData(View view) throws IOException {
        ...
        // TO.DO-C1 (3) Send request for 5 random cats here, don't forget to use {@link retrofit2.Call#enqueue}
