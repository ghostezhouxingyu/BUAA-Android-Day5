...
public interface IMiniDouyinService {
    // TO.DO-C2 (7) Implement your MiniDouyin PostVideo Request here,
    @Multipart
    @POST("invoke/video")
    ...
    // TO.DO-C2 (8) Implement your MiniDouyin Feed Request here, url: (GET) http://test.androidcamp.bytedance.com/mini_douyin/invoke/video
    @GET("invoke/video")
